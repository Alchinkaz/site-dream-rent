              ...
              <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg z-20 max-h-80 overflow-y-auto">
                {availableMopeds.map((moped) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-500 flex-shrink-0">от {moped.price.toLocaleString()} ₸</span>
                  </button>
                ))}
              </div>
            )}
            ...
            <div className="relative">
              ...
              >
                <span className={selectedTariff ? "text-gray-900 font-medium" : "text-gray-500"}>
                  {selectedTariffData
                    ? `${selectedTariffData.time} — ${selectedTariffData.price.toLocaleString()} ₸`
                    : "Выберите тариф"}
                </span>
                <ChevronDown
                ...
                <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg z-10">
                  {tariffs.map((tariff) => (
                    ...
                    >
                      ...
                      <span className="text-sm">{tariff.price.toLocaleString()} ₸</span>
                    </button>
                  ))}
                </div>
              )}
