...
import { ArrowLeft, Calendar, Gauge, Settings, ChevronDown, Clock } from 'lucide-react'
...
export default function ScootPage({ params }: { params: { id: string } }) {
  ...
  const handleBooking = () => {
    if (startDate && selectedTime && selectedTariff) {
      ...
      alert("Пожалуйста, выберите все необходимые данные для ��ронирования")
    }
  }
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg p-4 bg-gray-50 border border-gray-200">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-gray-900">{motorcycle.insurance ? motorcycle.insurance.toLocaleString() + ' ₸' : 'включена'}</span>
                  </div>
                  <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="flex justify-between items-center text-lg font-bold">
                    ...
                    <span className="text-gray-900">
                      {selectedTariff
                        ...
                        : (motorcycle.insurance || 0).toLocaleString()}{" "}
                      ₸
                    </span>
                  </div>
                </div>
