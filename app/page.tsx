          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <a
                  href="/cars"
                  className="mt-auto bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 text-center block"
                >
                  Смотреть предложения
                </a>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            <div className="lg:col-span-3 space-y-6">
              ...
              <p className="text-base text-gray-700 leading-relaxed">
                Наша аналитика показывает, что партнеры увеличивают объем бронирований в среднем на 35-40% в первый
                месяц сотрудничества, так как платформа объединяет спрос со всего Казахстана.
              </p>
            </div>
