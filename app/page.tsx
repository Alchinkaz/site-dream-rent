          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            <div className="lg:col-span-3 space-y-6">
              ...
              <p className="text-base text-gray-700 leading-relaxed">
                ...
                сэкономите время на обработку заявок благодаря автоматическому распределению бронирований. Наша
                аналитика показывает, что партнеры увеличивают объем бронирований в среднем на 35-40% в первый месяц
