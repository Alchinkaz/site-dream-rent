      ...
      >
        <div className="w-full max-w-lg rounded-2xl relative bg-white shadow-xl p-8">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="font-rubik font-bold text-2xl text-gray-900 mb-2">Спасибо за вашу заявку!</h2>
            <p className="text-gray-600 mb-6">
              Мы получили вашу заявку на бронь {motorcycle.name}. Свяжемся с вами в ближайшее время.
            </p>
            <p className="text-gray-600 mb-8">Или напишите нам в WhatsApp для более быстрого ответа:</p>
            ...
            <button onClick={handleCloseSuccess} className="text-gray-600 hover:text-gray-900 transition-colors">
              Закрыть
            </button>
          </div>
        </div>
      ...
      <div className="w-full max-w-lg rounded-2xl relative bg-white max-h-[90vh] overflow-hidden shadow-xl">
        ...
        >
          <div className="mb-6 pb-4 border-b border-gray-200">
            <h2 className="font-rubik font-bold text-2xl text-gray-900 mb-3">{motorcycle.name}</h2>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex justify-between items-center">
              ...
              <span className="text-gray-900 font-semibold">{formatPrice(rentalPrice)} ₸</span>
            </div>

            <div className="flex justify-between items-center">
              <span className="text-gray-700">Страховка:</span>
              <span className="text-gray-900 font-semibold">{formatPrice(insurancePrice)} ₸</span>
            </div>
            ...
            <div className="border-t border-gray-200 pt-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-gray-900 font-bold text-lg">{formatPrice(totalPrice)} ₸</span>
              </div>
            </div>
          </div>
